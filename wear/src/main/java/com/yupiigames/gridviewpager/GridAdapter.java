...
/**
 * Created by yair.carreno on 1/6/2016.
 */
public class GridAdapter extends FragmentGridPagerAdapter {
    ...
    public GridAdapter(Context ctx, FragmentManager fm) {
        ...
        mRows.add(new Row(cardFragment(R.string.dark_title, R.string.dark_text_1), cardFragment(
                R.string.dark_title, R.string.dark_text_2)));
        mRows.add(new Row(cardFragment(R.string.light_title, R.string.light_text_1), cardFragment(
                R.string.light_title, R.string.light_text_2), cardFragment(R.string.light_title,
                R.string.light_text_3)));
